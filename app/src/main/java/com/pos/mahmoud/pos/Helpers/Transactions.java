...
public class Transactions {
  ...
  public static Transactions getInstance() {
    ...
    private Transactions() {
        ...
        msgList.add(new TransactionItem(R.string.Mobile_bill_payment, Color.parseColor("#F9A825"),TransactionsType.Mobile_bill_payment,"payBill"));
        msgList.add(new TransactionItem(R.string.electricity, Color.parseColor("#00695C"),TransactionsType.electricity,"prepayBill"));
        msgList.add(new TransactionItem(R.string.mohe, Color.parseColor("#6A1B9A"),TransactionsType.mohe,"prepayBill"));
        msgList.add(new TransactionItem(R.string.mohe_arab, Color.parseColor("#1565C0"),TransactionsType.mohe_arab,"prepayBill"));
        msgList.add(new TransactionItem(R.string.e15, Color.parseColor("#D84315"),TransactionsType.E15,"prepayBill"));
        msgList.add(new TransactionItem(R.string.Customs, Color.parseColor("#AD1457"),TransactionsType.Customs,"payBill"));
