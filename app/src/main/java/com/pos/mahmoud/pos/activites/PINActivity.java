...
public class PINActivity extends AppCompatActivity implements View.OnFocusChangeListener, View.OnKeyListener, TextWatcher
{
     ...
     //   setDefaultPinBackground(mPinFifthDigitEditText);
       ...
       //     mPinFifthDigitEditText.setText("");
         ...
         //   mPinFifthDigitEditText.setText("");
          ...
          //  Toast.makeText(this,mPinHiddenEditText.getText(),Toast.LENGTH_SHORT).show();
            intent.putExtra("pin", mPinHiddenEditText.getText().toString());
